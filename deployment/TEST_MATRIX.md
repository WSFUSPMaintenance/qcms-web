...
| Snapshot publisher | Serialized, paginated, coordinated commit, governed identity | OIDC publisher implemented with pagination-cycle protection, concurrent-change retry, privacy-safe mapping, and atomic two-file commit; activation requires Entra federation and Sites.Selected grant | Implementation passed; activation blocked by identity provisioning |
