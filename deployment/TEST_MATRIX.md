...
| Power Apps dashboard | Direct SharePoint reads, role-aware navigation, delegable queues, mobile layout | Existing `USP QCMS` app previewed successfully against live SharePoint data. Four screens and seven data sources verified; blank Department, clipped ID, overlapping heading, approved-record waiting age, four delegation warnings, and missing operational screens remain. | In progress |
