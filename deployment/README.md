...
`artifacts/USPQAComplianceManagementSystem_1_0_0_2.zip` is the checksum-verified unmanaged Power Automate deployment baseline. Its manifest, integrity hash, component scope, and import/rollback guidance are recorded in `artifacts/README.md`.
